# deeplab v2: ResNet101 + ASPP, no multi scale input, for depth
...
class deeplab_depth(nn.Module):
    def __init__(self):
        ...
        self.Scale = ResNet(Bottleneck,[3, 4, 23, 3])
    ...
    def init_weights(self, use_pretrained_weights=False):
        ...
        if use_pretrained_weights:
            ...
            initial_state_dict = self.init_resnet101_params(resnet101)
            self.load_state_dict(initial_state_dict, strict=False)
        else:
            print("do not load pretrained weights for the monocular model")
    def init_resnet101_params(self, resnet101):
        initial_state_dict = resnet101.state_dict()
